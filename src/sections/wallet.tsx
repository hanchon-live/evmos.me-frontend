...
function WalletCard(props: WalletCardsProps) {
        ...
        >
            <Box width={{ base: 'full', sm: 'lg', lg: 'xl' }} margin={'auto'}>
                {/* <chakra.h3
                    ...
                    color={'teal.500'}>
                    Evmos.me - Your all in one wallet
                </chakra.h3> */}
                <chakra.h1
                    py={5}
                    fontSize={48}
